...
var BaselinePackages = []string{
	...
	"flex", "fonts-noto-color-emoji", "g++", "gcc", "gnupg2",
	...
	"net-tools", "netcat-openbsd", "openssh-client", "p7zip-full",
	"parallel", "patchelf", "pigz", "pkg-config",
	"pollinate", "python-is-python3", "rpm", "rsync", "shellcheck",
	"sqlite3", "ssh", "sshpass", "sudo", "swig",
